...
import { v2Fixture } from './shared/ringFixtures'

import RingExampleSlidingWindowOracle from '../build/RingExampleSlidingWindowOracle.json'
...
describe('RingExampleSlidingWindowOracle', () => {
  ...
  function deployOracle(windowSize: number, granularity: number) {
    return deployContract(wallet, RingExampleSlidingWindowOracle, [factory.address, windowSize, granularity], overrides)
  }
